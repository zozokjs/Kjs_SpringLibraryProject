	            ...
	            <div class="col-lg-8">
	               <div class="row">
						<div class="col-lg-12 mb-5">
							...
							<!-- 내용 Start-->
							<form id="comment-form" action="/user/${principal.user.id}/userUpdate"  method = "post" enctype="multipart/form-data" class="contact-form bg-white rounded p-5"  >
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											이메일<input type="text"  id="email"  name="email"  value = "${principal.user.email}"   class="form-control"   placeholder="이메일"  readonly="readonly">
										</div>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											연락처<input type="text"   id="phoneNumber"  name="phoneNumber"  value = "${principal.user.phoneNumber}"  class="form-control"  placeholder="연락처"  readonly="readonly">
										</div> 
									</div>
								</div>
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											주소<input type="text"  id="address"  name="address"  value = "${principal.user.address}"   class="form-control"   placeholder="주소"  readonly="readonly">
										</div>
									</div>
								</div>
								
 							<button>수정하기</button>
 							<button type ="button" onclick="exit()">탈퇴</button>
						</form>
