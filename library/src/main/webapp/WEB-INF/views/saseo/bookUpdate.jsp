							...
							<form id = "bookUpdate"  onsubmit="bookUpdate(${book.id},event)" enctype="multipart/form-data" class="contact-form bg-white rounded p-5" >
								...
								<div class="row">
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												권 수<input type="text"   	id="volume" name="volume"  value = "${book.volume}" class="form-control" placeholder="권수">
											</div>
										</div>
									</div>
									...
									줄거리
									<textarea  id="contents"  name="contents"  value = "${book.contents}" class="form-control mb-3"  cols="30" rows="5" placeholder="줄거리"></textarea>
								</div>
 							<button>등록</button>
						</form>
